...
User.create(name:"Sam John", username: "sjohn", email: "sjohn@gmail.com", address: "123-abc st.", phone_numnber: "(123) 123-1234", password: "123456", number_of_pianos: 4)
...
Appointment.create(date: "01_3_20", price: "4000", work_performed: "replaced hammer", notes_for_customer: "piano could use some work", user_id: 2, initial_a4_frequency: "430")
Appointment.create(date: "01_2_20", price: "2000", work_performed: "string splice", notes_for_customer: "piano could use some work", user_id: 3, initial_a4_frequency: "410")

Piano.create(model: "Steinway", serial: "09124WFEW", age: 200, image_url: "https://steinwaypianodb.imgix.net/584537/ABubinga1.jpg?&w=1080&h=auto" user_id: 1, appointment_id: 1, private_technical_notes: "YIKES!")
